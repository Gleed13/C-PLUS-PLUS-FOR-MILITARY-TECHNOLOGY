...
DroneMovementController::DroneMovementController(const DroneMotionProfile& motion_profile)
...
bool DroneMovementController::update(DroneState& drone, const DropPoint& destination)
{
    ...
    DroneMovementContext context{.drone = drone,
                                 .config = config,
...
float DroneMovementController::angleToTarget(const DroneState& drone, const Coord& target_position)
{
    ...
    const Coord drone_direction{std::cos(drone.direction), std::sin(drone.direction)};
...
void DroneMovementController::updatePosition(DroneState& drone, const DroneConfig& config)
{
